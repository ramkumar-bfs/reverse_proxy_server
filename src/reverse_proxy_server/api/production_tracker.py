...
@router.api_route("/production-tracker", methods=_APPLICATION_SETTINGS.supported_api_methods, tags=["production-tracker"], include_in_schema=False)
@router.api_route("/production-tracker/{full_path:path}", methods=_APPLICATION_SETTINGS.supported_api_methods, tags=["production-tracker"], include_in_schema=False)
